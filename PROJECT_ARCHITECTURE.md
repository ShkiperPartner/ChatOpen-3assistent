...
**Проект:** ChatOpenAI Integration Assistant + MaaS
**Версия:** 1.4
**Дата обновления:** 2025-02-05
**Статус:** Активная разработка + MaaS микросервис
...
- **Database:** Supabase (PostgreSQL) - 12 таблиц
  - Основное приложение: 4 таблицы
  - MaaS микросервис: 9 таблиц (2 вручную + 7 миграция)
- **Authentication:** Supabase Auth
- **File Storage:** OpenAI Files API (НЕ Supabase Storage)
- **AI Integration:** OpenAI Assistants API + Embeddings API
- **Memory System:** MaaS (Memory as a Service) - интеллектуальная память для AI
...
maas/                     # 🆕 MaaS микросервис
├── migrations/           # SQL миграции (7 таблиц)
├── scripts/              # Утилиты (создание данных, проверки)
├── README.md             # Документация MaaS
├── APPLY_MIGRATION.md    # Инструкция по миграции
...
### 4. MaaS Architecture: Memory as a Service 🆕

**Решение:** Отдельный микросервис для AI памяти
**Обоснование:**
- ✅ Модульная архитектура - можно использовать независимо
- ✅ 9 специализированных таблиц для разных аспектов памяти
- ✅ Граф связей между сущностями (facts, decisions, summaries)
- ✅ Масштабируемость - готов к интеграции с n8n/другими AI

**Структура данных:**
```
projects (центральная таблица)
├── facts (факты и контекст)
├── thread_summaries (саммари разговоров)
├── decisions (решения из чатов)
├── links (граф связей между сущностями)
...
### ✅ Готово (v1.4) - MaaS микросервис
- [x] 9 таблиц MaaS в Supabase (2 вручную + 7 миграция)
- [x] Тестовые данные с примерами использования
- [x] SQL миграции и утилиты проверки
- [x] Документация структуры (README, APPLY_MIGRATION)
- [x] Проверочный скрипт full-check.mjs

### 🚧 В разработке
- [ ] Integration testing для file upload
- [ ] Error handling improvements
- [ ] Интеграция MaaS с основным приложением
- [ ] n8n workflow для автоматического извлечения фактов
...
- [ ] API endpoints для MaaS
- [ ] Векторный поиск по фактам
- [ ] Dashboard визуализации связей MaaS
...
*Последнее обновление: 2025-02-05 (добавлен MaaS микросервис - 9 таблиц, v1.4)*